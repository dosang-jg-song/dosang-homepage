...
category: "AX"
author: "도상 컨설팅팀"
summary: "AI 생성 ABAP 코드의 사실 정확성을 검증하는 도상 자체 워크플로. 5개 검증 단계와 자동화 도구를 소개합니다."
tags: ["AX", "ABAP", "Fact Verification", "Hallucination"]
featured: false
readMin: 8
---

AI 생성 코드의 가장 큰 위험은 **할루시네이션**입니다. 존재하지 않는 BAPI를 호출하고, 시그니처를 틀리게 쓰고, 폐기된 트랜잭션 코드를 인용하는 식입니다. 도상은 이런 오류를 걸러내기 위해 5단계 사실 검증 워크플로를 운영합니다.
